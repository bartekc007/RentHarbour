...
{
    public class GetDocumentsByOfferIdQueryHandler : IRequestHandler<GetDocumentsByOfferIdQuery, List<OfferDocumentDto>>
    {
        private readonly IDocumentRepository _documentRepository;
        private readonly IMapper _mapper;

        public GetDocumentsByOfferIdQueryHandler(IDocumentRepository documentRepository, IMapper mapper)
        {
