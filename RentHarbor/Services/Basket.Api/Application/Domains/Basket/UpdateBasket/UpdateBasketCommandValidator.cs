    ...
    public class UpdateBasketCommandValidator : AbstractValidator<UpdateBasketCommand>
    {
        public UpdateBasketCommandValidator()
        {
            RuleFor(x => x.UserId)
                ...
                .Length(36).WithMessage("UserId must be 36 characters long."); // Assuming GUID length, adjust as needed

            RuleFor(x => x.PropertyId)
                .NotEmpty().WithMessage("PropertyId is required.")
                .Length(36).WithMessage("PropertyId must be 36 characters long."); // Assuming GUID length, adjust as needed
